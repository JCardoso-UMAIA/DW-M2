...
module.exports.createFilmeid = function createFilmeid (req, res, next, body, id) {
  Filme.createFilmeid(body, id)
    .then(function (response) {
      utils.writeJson(res, response);
    })
    .catch(function (response) {
...
module.exports.getFilmeid = function getFilmeid (req, res, next, id) {
  Filme.getFilmeid(id)
    .then(function (response) {
      utils.writeJson(res, response);
    })
