...
module.exports.createPessoaid = function createPessoaid (req, res, next, body, id) {
  Pessoa.createPessoaid(body, id)
    .then(function (response) {
      utils.writeJson(res, response);
    })
    .catch(function (response) {
...
module.exports.getPessoaid = function getPessoaid (req, res, next, id) {
